...
<body>
	<header>
		<div id="afterNav">
			<h4 id="websiteBrand"><a href="index.html">www.zodiac-piscine.ro </a> | Acasa</h4>
			<div id="mediaLinks">
		...
		<nav>
			<div id="logo"></div>
			<div id="formWrapper">
				<form id="searchForm" method="GET" action="produse-search.php">
					<input type="text" name="search" id="searchInput" placeholder="cauta un produs...">
